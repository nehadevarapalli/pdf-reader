...
class ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF:
    ...
    def create_output_file_path() -> str:
        ...
        os.makedirs("output/ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF", exist_ok=True)
        return f"output/ExtractTextTableInfoWithFiguresTablesRenditionsFromPDF/extract{time_stamp}.zip"
